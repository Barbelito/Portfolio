...
- **Contact Form** - Integrated contact form with validation powered by FormSubmit
- **Responsive Design** - Adaptive and responsive layouts that work perfectly on mobiles of all sizes
...
4. **Send a Message** - Fill out the contact form with your name, email, and message, then hit submit
...
- Hamburger menu toggle for screens below 768px
- Smooth transitions and accessibility support
- Auto-closes when clicking navigation links or outside the nav (using JS)

### Shooting Star Background

- Dynamically spawned stars that animate across the viewport
...
- Projects and testimonials use CSS Grid with `auto-fit`
...
Any questions regarding anything? Feel free to reach out!
